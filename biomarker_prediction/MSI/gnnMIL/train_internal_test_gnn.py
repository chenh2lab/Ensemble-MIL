...
for fold, (train_index, test_index) in enumerate(kfold.split(x_ids, y_label)):
    ...
    for epoch in range(n_epochs):
        ...
        if valid_loss < best_valid_loss:
            ...
            best_epoch = epoch + 1
            torch.save(model.state_dict(), f'/staging/biology/u1307362/MSI/gnnMIL/simclr/fold_{fold}_gnn.pt')
    ...
    model_test.load_state_dict(torch.load(f'/staging/biology/u1307362/MSI/gnnMIL/simclr/fold_{fold}_gnn.pt'))
    ...
    np.save(f'/staging/biology/u1307362/MSI/gnnMIL/simclr/labels_fold_{fold}.npy', labels)
    np.save(f'/staging/biology/u1307362/MSI/gnnMIL/simclr/pred_labels_fold_{fold}.npy', pred_labels)
    np.save(f'/staging/biology/u1307362/MSI/gnnMIL/simclr/probs_fold_{fold}.npy', probs)
    np.save(f'/staging/biology/u1307362/MSI/gnnMIL/simclr/pred_fold_{fold}.npy', pred)

# import labels
labels_0 = np.load('/staging/biology/u1307362/MSI/gnnMIL/simclr/labels_fold_0.npy')
labels_1 = np.load('/staging/biology/u1307362/MSI/gnnMIL/simclr/labels_fold_1.npy')
labels_2 = np.load('/staging/biology/u1307362/MSI/gnnMIL/simclr/labels_fold_2.npy')
labels_3 = np.load('/staging/biology/u1307362/MSI/gnnMIL/simclr/labels_fold_3.npy')
labels_4 = np.load('/staging/biology/u1307362/MSI/gnnMIL/simclr/labels_fold_4.npy')

# import probs
probs_0 = np.load('/staging/biology/u1307362/MSI/gnnMIL/simclr/probs_fold_0.npy')
probs_1 = np.load('/staging/biology/u1307362/MSI/gnnMIL/simclr/probs_fold_1.npy')
probs_2 = np.load('/staging/biology/u1307362/MSI/gnnMIL/simclr/probs_fold_2.npy')
probs_3 = np.load('/staging/biology/u1307362/MSI/gnnMIL/simclr/probs_fold_3.npy')
probs_4 = np.load('/staging/biology/u1307362/MSI/gnnMIL/simclr/probs_fold_4.npy')
