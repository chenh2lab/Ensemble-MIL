...
# split training, testing ID 'MSS(86), MSI-H(24)'
...
for fold in range(k_folds):
    ...
    # model
    model = AttnClassifier(input_dim = 2048, attn_dim = 1024, output_dim = 2).to(device)
    model.load_state_dict(torch.load(f'/staging/biology/u1307362/MSI/attMIL/simclr/fold_{fold}_attention.pt'))
    ...
    np.save(f'/staging/biology/u1307362/external_validation/CPTAC-COAD/MSI/attMIL/simclr/labels_fold_{fold}.npy', labels)
    np.save(f'/staging/biology/u1307362/external_validation/CPTAC-COAD/MSI/attMIL/simclr/pred_labels_fold_{fold}.npy', pred_labels)
    np.save(f'/staging/biology/u1307362/external_validation/CPTAC-COAD/MSI/attMIL/simclr/probs_fold_{fold}.npy', probs)
    np.save(f'/staging/biology/u1307362/external_validation/CPTAC-COAD/MSI/attMIL/simclr/pred_fold_{fold}.npy', pred)

# import labels
labels_0 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/MSI/attMIL/simclr/labels_fold_0.npy')
labels_1 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/MSI/attMIL/simclr/labels_fold_1.npy')
labels_2 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/MSI/attMIL/simclr/labels_fold_2.npy')
labels_3 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/MSI/attMIL/simclr/labels_fold_3.npy')
labels_4 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/MSI/attMIL/simclr/labels_fold_4.npy')

# import probs
probs_0 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/MSI/attMIL/simclr/probs_fold_0.npy')
probs_1 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/MSI/attMIL/simclr/probs_fold_1.npy')
probs_2 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/MSI/attMIL/simclr/probs_fold_2.npy')
probs_3 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/MSI/attMIL/simclr/probs_fold_3.npy')
probs_4 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/MSI/attMIL/simclr/probs_fold_4.npy')
