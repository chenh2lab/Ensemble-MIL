...
class AttnClassifier(nn.Module):
    def __init__(self, input_dim, attn_dim, output_dim, lambda_l1, dropout = True, p_dropout = 0.5):
        ...
        self.fc = nn.Sequential(nn.LayerNorm(input_dim), nn.Linear(input_dim, output_dim))
    ...
    def forward(self, x):
        ...
        alpha_V = self.attention_V(x)   # (N, 1024)
...
# ID 'KRAS wildtype(75), mutation(35)'
...
for fold in range(k_folds):
    ...
    model.load_state_dict(torch.load(f'/staging/biology/u1307362/KRAS/attMIL/simclr/fold_{fold}_attention.pt'))

    labels, pred_labels, probs = get_predictions(model, test_iterator)
    evaluated_metrics(labels, pred_labels, probs)

    # confusion matrix
    plot_confusion_matrix(labels, pred_labels, classes, title = 'KRAS prediction')
    ...
    np.save(f'/staging/biology/u1307362/external_validation/CPTAC-COAD/KRAS/attMIL/simclr/labels_fold_{fold}.npy', labels)
    np.save(f'/staging/biology/u1307362/external_validation/CPTAC-COAD/KRAS/attMIL/simclr/pred_labels_fold_{fold}.npy', pred_labels)
    np.save(f'/staging/biology/u1307362/external_validation/CPTAC-COAD/KRAS/attMIL/simclr/probs_fold_{fold}.npy', probs)
    np.save(f'/staging/biology/u1307362/external_validation/CPTAC-COAD/KRAS/attMIL/simclr/pred_fold_{fold}.npy', pred)

# import labels
labels_0 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/KRAS/attMIL/simclr/labels_fold_0.npy')
labels_1 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/KRAS/attMIL/simclr/labels_fold_1.npy')
labels_2 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/KRAS/attMIL/simclr/labels_fold_2.npy')
labels_3 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/KRAS/attMIL/simclr/labels_fold_3.npy')
labels_4 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/KRAS/attMIL/simclr/labels_fold_4.npy')

# import probs
probs_0 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/KRAS/attMIL/simclr/probs_fold_0.npy')
probs_1 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/KRAS/attMIL/simclr/probs_fold_1.npy')
probs_2 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/KRAS/attMIL/simclr/probs_fold_2.npy')
probs_3 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/KRAS/attMIL/simclr/probs_fold_3.npy')
probs_4 = np.load('/staging/biology/u1307362/external_validation/CPTAC-COAD/KRAS/attMIL/simclr/probs_fold_4.npy')
