...
location = '/staging/biology/u1307362/TCGA-COAD_tile_location'
features = '/staging/biology/u1307362/TCGA-COAD_norm_tumor_feature/simclr/vgg19_bn/TCGA-HE-89K'
adjacency = '/staging/biology/u1307362/adjacency/TCGA-COAD'

for csv in os.listdir(features):
    if os.path.isfile(os.path.join(adjacency, csv[:-4] + '.npy')):
        pass
    else:
